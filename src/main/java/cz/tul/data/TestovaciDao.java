...
//        params.addValue("nazev", testovaci.getNazev());
//        params.addValue("pocet", testovaci.getPocet());
//        params.addValue("jmeno", testovaci.getJmeno());

        params.addValue("nazev", "asdf");
        params.addValue("pocet", 666);
        params.addValue("jmeno", "ssssss");


//        BeanPropertySqlParameterSource params = new BeanPropertySqlParameterSource(testovaci);

        return jdbc
                .update("insert into testovaci (nazev, pocet, jmeno) values ('asdf', 32, 'asdfafasfd')",
                        params) == 1;
    }
