...
public class PictureDaoTests {
    ...
    public void testCreatePicture() throws SQLException {
        ...
        Picture picture = new Picture(author, "http://url.cz", "test JDBC", new Date());
    ...
    public void testDeletePicture() throws SQLException {
        ...
        Picture picture1 = new Picture(author, "http://url.cz", "pokus 1", new Date());
        Picture picture2 = new Picture(author, "http://url.cz", "pokus 1", new Date());
        Picture picture3 = new Picture(author, "http://url.cz", "pokus 1", new Date());
